...
class ActualizadorListaLibros extends  AsyncTask<String ,Integer , List<Libro> > implements AsyncTaskInterface{
	...
	/**
	 * Este mï¿½todo es el encargado de revisar la lista de libros recuperados
	 * por si alguno estï¿½ pasado de fecha, le falta un dï¿½a o debe ser renovado hoy.
	 * 
	 * @param res
	 */
		...
		if((renovables != 0) || (expiranHoy != 0) || (pasadosDeFecha != 0)){
			...
			NotificationCompat.Builder mBuilder =
				    new NotificationCompat.Builder(contexto)
				        ...
				        .setContentText(pasadosDeFecha + " Pasados " + expiranHoy +" Hoy " + renovables +" MaÃ±ana")
