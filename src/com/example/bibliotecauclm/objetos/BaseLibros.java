...
public class BaseLibros extends SQLiteOpenHelper{
	 ...
	 * 		 de no poderse, la clave primaria es el t�tulo, de otra forma, nos las tenemos
	 * 		 que arreglar para saber cuando un libro esta desactualizado o no.
	 * 
	 * IDEA: podemos usar como clave primaria la posici�n que el libro ocupa en la tabla de la biblioteca,
	 ...
	 * 
	 * P.D. Lo id�neo ser�a poder hacerlo con los identificadores, el problema es que esos identificadores no los
	 * 		tenemos hasta que el libro se puede renovar (un d�a antes de la fecha de expiraci�n). Normalmente ese campo
	 * 		va estar a null.
	 * 	
	 */
	...
	/**
	 * Obtiene la base de datos, tan solo ll�malo y usa los m�todos.
	...
	/**
	 * Este m�todo inserta en la base de datos, todos los libros que le pases
	 * en la lista. �CUIDADO! si el libro ya est�, se insertar� igual. Para actualizar,
	 * utiliza el m�todo actualizarBase().
	 * 
	 * @param libros
	 */
	...
	/**
	 * Este m�todo obtiene una lista completa de todos los libros existentes en la
	 * base de datos. La lista ser� vac�a si no hay nada.
	 * 
	 * @return
	 */
	...
	/**
	 * Este m�todo elimina todos los registros de la base de datos
	 * y los inserta de nuevo. Versi�n temporal. 
	 * 
	 * @param libros
	 */
